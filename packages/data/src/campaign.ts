...
/** Same gaps in EN for chrome i18n. Affix strings stay source-backed elsewhere. */
...
const CHAPTERS: CampaignChapter[] = [
  ...
  },
  {
    ...
    labelZh: "第二章",
    labelEn: "Act 2",
    summaryZh: "三抗開始值得掃商店；與生命、移速一併預設為「是」（AND）。",
    summaryEn: "Fire/cold/lightning resists join life and move speed as default Yes (AND) picks.",
    maps: [],
